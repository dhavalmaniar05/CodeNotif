...
public class CodeChefDetails extends RecyclerView.Adapter<CodeChefDetails.ViewHolder> implements TimePickerDialog.OnTimeSetListener{
    private List<com.example.cchelper.codeChefData> listitem;

    private Context context;

    public CodeChefDetails(List<com.example.cchelper.codeChefData> listitem, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(parent.getContext()).inflate(R.layout.codechefdetails,parent,false);
