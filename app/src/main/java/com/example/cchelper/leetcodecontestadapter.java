...
public class leetcodecontestadapter extends RecyclerView.Adapter<leetcodecontestadapter.ViewHolder> implements TimePickerDialog.OnTimeSetListener{

    private List<ListItems> contest_data;
    private Context context;

    public leetcodecontestadapter(List<ListItems> contestdata, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(parent.getContext()).inflate(R.layout.leetcodecontests,parent,false);
