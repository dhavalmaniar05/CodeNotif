...
public class LeetCodeHomePage extends RecyclerView.Adapter<LeetCodeHomePage.ViewHolder> implements TimePickerDialog.OnTimeSetListener{
    private List<ContestPagesModel> listitem;

    private Context context;

    public LeetCodeHomePage(List<ContestPagesModel> listitem,  Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(parent.getContext()).inflate(R.layout.homepageleetcode,parent,false);
